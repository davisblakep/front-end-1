   ...
   const toggleItem = dataID => {
    ...
    return(
        ...
        <div style={{padding: "6%"}}>
            ...
            <Grid container spacing={7} display='flex' justify="space-around" align="center">
      ...
      <CardActions>
          {item.isSelected ? <Button onClick={(() => toggleItem(item.id))} size="small" color="primary">
          Remove
      ...
      <CardActions>
          {item.isSelected ? <Button size="small" color="primary">
          Remove
        </Button> : <Button onClick={(() => toggleItem(item.id))} size="small" color="primary">
          Add
        </Button>}
        {/* <Button size="small" color="primary">
          Add
