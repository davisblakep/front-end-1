    ...
    <Card className={classes.root} variant="outlined" style={{backgroundColor: "black"}}>
      <CardContent>
        ...
        <Typography variant="body2" component="p" style={{color: "lightgray"}}>
          A site where your goals and values can move you in the direction of a more essential and minimal lifestyle.  Less is more.
        </Typography>
      </CardContent>
      <CardActions>
          <Link to="/createuser">
        <Button size="small" style={{color: "white"}}>Signup</Button>
        </Link>
        <Link to="/login">
